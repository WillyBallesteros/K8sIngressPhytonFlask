...
Microservicio para la gestión de trayectos.
...
$> pip install pipenv
$> pipenv install --dev
$> FLASK_APP=src/main.py pipenv run flask run -h 0.0.0.0 -p 3002
```
...
- [Creación de trayecto](https://github.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-202411/wiki/Gesti%C3%B3n-de-Trayectos#1-creaci%C3%B3n-de-trayecto)
- [Ver y filtrar trayectos](https://github.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-202411/wiki/Gesti%C3%B3n-de-Trayectos#2-ver-y-filtrar-trayectos)
- [Consultar un trayecto](https://github.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-202411/wiki/Gesti%C3%B3n-de-Trayectos#3-consultar-un-trayecto)
- [Eliminar trayecto](https://github.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-202411/wiki/Gesti%C3%B3n-de-Trayectos#4-eliminar-trayecto)
- [Consulta de salud del servicio](https://github.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-202411/wiki/Gesti%C3%B3n-de-Trayectos#5-consulta-de-salud-del-servicio)
- [Restablecer base de datos](https://github.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-202411/wiki/Gesti%C3%B3n-de-Trayectos#6-restablecer-base-de-datos)
...
$> deactivate
```
También se puede ejecutar una batería de pruebas declaradas en postman en el archivo: https://raw.githubusercontent.com/MISW-4301-Desarrollo-Apps-en-la-Nube/proyecto-monitor/main/entrega1/entrega1.json en la carpeta Routes


## Autor

Luis Daniel Angel
l.angelb@uniandes.edu.co